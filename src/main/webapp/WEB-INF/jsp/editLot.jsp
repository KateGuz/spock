            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="edit-lot-details-wrapper">
                        ...
                        <div class="edit-field-wrapper">
                            <textarea class="form-control" rows="7" cols="60" required>"${lot.description}"</textarea>
                        </div>
                        <div class="edit-field-wrapper">
                            <span>Начальная ставка (UAH):</span>
                            <input type="number" class="form-control" value="${lot.startPrice}" size="10" required>
                        </div>
                        <div class="edit-field-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="save-changes-button">
                    <button type="submit" class="btn btn-success save-changes-button">Сохранить изменения</button>
                </div>
            </div>
        </div>
    </form>
