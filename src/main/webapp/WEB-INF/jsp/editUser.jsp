                ...
                <div class="row">
                    <div class="col-md-4 user-details-wrapper">
                        <div class="thumbnail user-photo">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjMtcxK2vElKxVOi9b1noqIKLvCEEsvr9wK4frJOnSHfxrt6rz9aiRz-4">
                        </div>
                        <div class="user-info">
                                        ...
                                        <div class="lot-preview-item jumbotron">
                                            ...
                                            <div class="lot-preview-current-price">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <span>Максимальная ставка: ${currentPrice.get(lot.id)} ${currency}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            ...
                                            <div class="user-lot-controls">
                                                <form class="user-lot-edit-button" action="/lot/${lot.id}/edit">
                                                    <a class="btn btn-default"
                                                       href="/lot/${lot.id}/edit">Редактировать</a>
                                                </form>
