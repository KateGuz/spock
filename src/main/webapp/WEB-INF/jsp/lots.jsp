        ...
        <div class="col-md-11">
            <c:forEach items="${lots}" var="lot" begin="0" end="8">
                <div class="col-md-4">
                    ...
                    <a class="btn btn-default" onclick="">"${lot.quickBuyPrice}"<br>Купить сейчас</a>
                    <a class="btn btn-default" href="/lot/${lot.id}"><br>Детали:</a>
                    ...
                    <c:choose>
                        <c:when test="${lot.maxBid==null}">
                            <c:out value="цена сейчас: ${lot.startPrice} "/>
                        </c:when>
                        <c:otherwise>
                            <c:out value="цена сейчас: ${lot.maxBid.value}"/>
                        </c:otherwise>
                    </c:choose>
                    <br>
                    <br>
