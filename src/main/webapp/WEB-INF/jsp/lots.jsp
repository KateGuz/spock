                    ...
                    <div class="col-md-12">
                        ...
                        <section class="filters-section">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-default" id="btnSortSoonest">Скоро заканчиваются</button>
                                <button type="button" class="btn btn-default" id="btnSortDesc">От дорогих к дешевым</button>
                                <button type="button" class="btn btn-default" id="btnSortAsc">От дешевых к дорогим</button>
                                <button type="button" class="btn btn-default" id="btnSortClear">Сбросить фильтры</button>
                            </div>
                        </section>
                        <br>
