    ...
    <div class="row">
        <div class="col-md-3">
            <img class="img-thumbnail img" width="300" height="225"
                 src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjMtcxK2vElKxVOi9b1noqIKLvCEEsvr9wK4frJOnSHfxrt6rz9aiRz-4"><br>
                  <c:out value="Имя: ${user.name}"></c:out><br>
            <c:out value="Почта: ${user.email}"></c:out><br>
            <c:out value="Дата регестрации: ${user.registrationDate}"></c:out><br>
        </div>
        <div class="col-md-9">
                ...
                <div class="col-md-4">
                    ...
                    <c:choose>
                        <c:when test="${lot.maxBid==null}">
                            <c:out value="цена сейчас: ${lot.startPrice} ,${lot.currency}"/><br>
                        </c:when>
                        <c:otherwise>
                            <c:out value="цена сейчас: ${lot.maxBid.value} ,${lot.currency}"/><br>
                        </c:otherwise>
                    </c:choose>
                    <c:out value="статус лота: ${lot.type}"/><br>
                    <br>
                    <br>
                </div>
            </c:forEach>
